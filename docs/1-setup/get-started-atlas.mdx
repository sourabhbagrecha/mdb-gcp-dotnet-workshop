...
You will deploy the cluster using the Atlas UI, so before starting, make sure you’re logged into your [account](https://cloud.mongodb.com?utm_campaign=devrel&utm_source=workshop&utm_medium=cta&utm_content=gcp_dotnet_workshop&utm_term=megha.arora_sourabh.bagrecha).
